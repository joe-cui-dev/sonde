...
export function usd(n: number): string {
  // A one-turn writing run costs tens of microdollars, and four decimals render
  // every one as "$0.0000" — free rather than cheap. Below a hundredth of a
  // cent gets more digits.
